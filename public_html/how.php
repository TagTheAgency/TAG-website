...
<div class="master-container">
	...
	<div id="how-creative" class="flex-row sml-row light-section reverse how-section blue">
		<div class="flex-col">
			<img src="img/backgrounds/how-creative.png" alt="strat image">
		</div>
		<div class="flex-col">
			<div class="info">
				<h2>Creative</h2>
	...
	<div id="how-copywriting" class="flex-row lrg-row how-section">
		<div class="flex-col">
			<img src="img/backgrounds/how-copywriting.png" alt="copywriting section image">
		</div>
		<div class="flex-col">
			<div class="info  left-align">
				<h2>Copywriting</h2>
	...
	<div id="how-design" class="flex-row sml-row reverse yellow how-section">
		<div class="flex-col">
			<img src="img/backgrounds/how-design-alt.png" alt="design section image">
		</div>
		<div class="flex-col">
			<div class="info">
				<h2>Design</h2>
...
" target="_blank">Take A Peek</a> <span class="hover-bar"></span></div>
	...
	<div id="how-advertising" class="flex-row lrg-row how-section">
		<div class="flex-col">
			<img src="img/backgrounds/how-advertising.png" alt="copywriting section image">
		</div>
		<div class="flex-col">
			<div class="info  left-align">
				<h2>Advertising</h2>
